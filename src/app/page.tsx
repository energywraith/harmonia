  ...
  return (
    <div>
      <Container className="pb-0">
        <h1 className="flex flex-col lg:flex-row lg:gap-[1ch] items-center lg:justify-center font-passion px-4">
          <span className="text-2xl lg:text-6xl">Welcome To</span>
          <span className="text-5xl lg:text-6xl">HARMONIA</span>
        </h1>
        <p className="text-base lg:text-xl font-bold text-center px-4 lg:px-16 mt-6 lg:mt-3">
